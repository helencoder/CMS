...
var TableInit = function () {
    ...
    oTableInit.queryParams = function (params) {
        var temp = {   //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
            ...
            name: $("#txt_search_name").val(),  // 姓名
            phone: $("#txt_search_phone").val()    // 手机号
        };
        return temp;
    };
    return oTableInit;
...
var ButtonInit = function () {
    ...
    oInit.Init = function () {
        ...
        $("#btn_edit").click(function () {
            ...
            $("#txt_address").val(arrselections[0].address);
            $("#txt_company").val(arrselections[0].company);
        ...
        $("#btn_submit").click(function () {
            ...
            postdata.company = $("#txt_company").val();
